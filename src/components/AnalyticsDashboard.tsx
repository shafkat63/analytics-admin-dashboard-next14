...
const Badge = ({ percentage }: { percentage: number }) => {
	...
	const nuetralClassName = "bg-zinc-900/25 text-zinc-400 ring-zinc-400/25";
	...
	return (
		...
		>
			...
			{isNeutral ? <ArrowUpRight className="h-3 w-3" /> : null}
